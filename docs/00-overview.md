...
詳細は `docs/decisions/2026-05-09-fused-kernel-strategy.md`。

## 依存関係

- **bullet-shogi / bullet (MIT)**: PSV format / shogi 型 / feature 定義 / loss
  数式 / 量子化定数を vendor (`ATTRIBUTION.md` 参照)。vendor を選んだ理由と
  cuda-oxide を git dep にする理由は `docs/decisions/2026-05-09-vendor-vs-dep.md`。
...
- 設計判断は ADR (`docs/decisions/`) に、性能計測 / 仮説検証経緯は
