...
|---|---|---|---|---|---|---|---|
| `fused_screlu_grad` | 2-3 | activation gradient (forward 経路と組合せ) | `crates/compiler/src/tensor/operation/autograd/dfo.rs::SCReLU` | `pointwise/screlu_grad.rs` (TBD) | `experiments/002-fused-kernels/src/main.rs` | #37 | 未実装 |
