...
├── nodchip_hao_depth9/                  # 連続 PSV (1016 files / 約 299 GB)
├── nodchip_suisho5_entering_king/       # 連続 PSV 入玉特化 (127 files / 約 19 GB)
├── DLSuisho15b_aoba_deduped_shuffled.bin  # shuffle 済 (NNUE 本番、約 616 GB)
├── DLSuisho15b_deduped_shuffled.bin     # 同上 aobazero 抜き (約 547 GB)
...
原理的に使えない)。HalfKA_hm 等 shuffle が望ましい学習に使う。
...
- `data/progress/progress_haoek_full_cuda.bin` — 1143 files × 5 epoch
