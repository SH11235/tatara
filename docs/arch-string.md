...
- `<feature_name>`: feature set のアーキ名 (`HalfKA_hm` / `HalfKP` など)。
...
`HalfKA_hm` feature set・FT 出力 1536・`fv_scale=28` の場合:
...
```
Features=HalfKA_hm(Friend)[73305->256x2],Network=AffineTransform[1<-32](ClippedReLU[32](AffineTransform[32<-32](ClippedReLU[32](AffineTransformSparseInput[32<-512](InputSlice[512(0:512)]))))),fv_scale=13
```

活性化 `screlu` (`fv_scale=27`):

```
Features=HalfKA_hm(Friend)[73305->256x2],Network=AffineTransform[1<-32](SqrClippedReLU[32](AffineTransform[32<-32](SqrClippedReLU[32](AffineTransformSparseInput[32<-512](InputSlice[512(0:512)]))))),fv_scale=27
```
